...
public class ThriftExampleService {

  public interface Iface {

    public String test(int id, String message) throws TException;

  }

  public interface AsyncIface {

    public void test(int id, String message, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String test(int id, String message) throws TException
    {
      send_test(id, message);
      return recv_test();
    }

    public void send_test(int id, String message) throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void test(int id, String message, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      test_call method_call = new test_call(id, message, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class test_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public test_call(int id, String message, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class test<I extends Iface> extends org.apache.thrift.ProcessFunction<I, test_args> {
      ...
      public test_result getResult(I iface, test_args args) throws TException {
        test_result result = new test_result();
        result.success = iface.test(args.id, args.message);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class test<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, test_args, String> {
      ...
      public void start(I iface, test_args args, AsyncMethodCallback<String> resultHandler) throws TException {
        iface.test(args.id, args.message,resultHandler);
      }
    }
  ...
  public static class test_args implements org.apache.thrift.TBase<test_args, test_args._Fields>, java.io.Serializable, Cloneable, Comparable<test_args>   {
    ...
    public test_args setMessage(String message) {
      this.message = message;
      return this;
    }
